            ...
            steps {
                script {
                    ...
                    withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', credentialsId: 'aws-jenkins']]) {
                        ...
                        sh "aws ecr-public get-login-password --region eu-central-1 | docker login --username AWS -p ${aws ecr-public get-login-password --region eu-central-1} public.ecr.aws"
